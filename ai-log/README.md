...
| [`04_pos_auditoria_chatgpt.md`](04_pos_auditoria_chatgpt.md) | Registro técnico da rodada pós-auditoria | Resumo verificável; não é transcrição completa do chat do conector |
...
6. **Pós-auditoria reproduzível:** [`04_pos_auditoria_chatgpt.md`](04_pos_auditoria_chatgpt.md) documenta bootstrap por proprietário/anunciante, deduplicação, cenários líquidos e buy box.
